...
@Component({
  selector: 'ngx-app-camera-pertamanan',
  templateUrl: './camera-pertamanan.component.html',
  styleUrls: ['./camera-pertamanan.component.scss'],
})
export class CameraPertamananComponent implements OnInit {
  @Output()
