...
@Component({
  selector: 'ngx-grafik-peta-perumahan',
  templateUrl: `grafik-peta-perumahan.component.html`,
  styleUrls: ['./grafik-peta-perumahan.component.scss'],
})
export class GrafikPetaPerumahanComponent implements AfterViewInit, OnDestroy, OnChanges {
