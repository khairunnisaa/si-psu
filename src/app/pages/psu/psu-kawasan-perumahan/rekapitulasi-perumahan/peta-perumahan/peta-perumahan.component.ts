...
@Component({
  selector: 'ngx-peta-perumahan',
  templateUrl: `peta-perumahan.component.html`,
  styleUrls: ['./peta-perumahan.component.scss'],
})
export class PetaPerumahanComponent implements OnDestroy {
