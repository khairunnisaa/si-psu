...
import { PetaKabBogorService } from "./peta-kab-bogor.service";
import { NbThemeService } from '@nebular/theme';
import { combineLatest } from 'rxjs';
import { takeWhile } from 'rxjs/operators';

@Component({
  selector: 'ngx-peta-kab-bogor-perumahan',
  templateUrl: 'peta-kab-bogor-perumahan.component.html',
  styleUrls: ['./peta-kab-bogor-perumahan.component.scss'],
})
export class PetaKabBogorPerumahanComponent implements OnDestroy {
  ...
  options = {
    ...
    maxZoom: 30,
    zoomControl: false,
    center: L.latLng({lat: -6.480470, lng: 106.458810}),
  ...
  constructor(private ecMapService: PetaKabBogorService,
